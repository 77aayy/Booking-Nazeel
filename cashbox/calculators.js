...
function handleCashCalcInput(event) {
  ...
  const cashCalcTotal = document.getElementById("cashCalcTotal");
  if (cashCalcTotal) {
    cashCalcTotal.textContent = grandTotal.toString();
  }
}
